...
<parameter name="title">CTO Layout Engine</parameter>
<parameter name="id">cto_layout_js</parameter>
<parameter name="content">/**
 * AndroGov CTO Layout Engine v1.0
 * @file cto/js/components/layout.js
 * @author Ayman Al-Maghrabi
 * @description Technical leadership layout for Chief Technology Officer
 */
...
console.log(`✅ AndroGov CTO Layout Ready | Lang: ${getCurrentLang()}`);
}
...
icon: 'fa-ticket',
color: 'blue',
title: { ar: 'تذكرة دعم حرجة', en: 'Critical Support Ticket' },
body: { ar: '2 تذاكر تحتاج اهتمام فوري', en: '2 tickets need immediate attention' },
time: new Date(Date.now() - 1000 * 60 * 60 * 5),
read: true,
link: 'cto_support.html'
}
];
}
      ...
      <div class="relative group cursor-pointer">
        <div class="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900 border border-slate-200 dark:border-slate-700 transition-all hover:shadow-md">
          <img src="${user?.avatar || 'https://ui-avatars.com/api/?name=CTO&background=EC4899&color=fff'}" 
               ...
               onerror="this.src='https://ui-avatars.com/api/?name=CTO&background=EC4899&color=fff'">
